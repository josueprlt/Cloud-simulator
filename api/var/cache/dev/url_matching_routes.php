...
return [
    ...
    [ // $dynamicRoutes
        ...
        288 => [[['_route' => '_api_/voyages/{id}{._format}_get', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Voyage', '_api_operation_name' => '_api_/voyages/{id}{._format}_get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        314 => [
            [['_route' => '_api_/voyages{._format}_get_collection', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Voyage', '_api_operation_name' => '_api_/voyages{._format}_get_collection'], ['_format'], ['GET' => 0], null, false, true, null],
            [['_route' => '_api_/voyages{._format}_post', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Voyage', '_api_operation_name' => '_api_/voyages{._format}_post'], ['_format'], ['POST' => 0], null, false, true, null],
        ],
        352 => [
            [['_route' => '_api_/voyages/{id}{._format}_patch', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Voyage', '_api_operation_name' => '_api_/voyages/{id}{._format}_patch'], ['id', '_format'], ['PATCH' => 0], null, false, true, null],
            [['_route' => '_api_/voyages/{id}{._format}_delete', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Voyage', '_api_operation_name' => '_api_/voyages/{id}{._format}_delete'], ['id', '_format'], ['DELETE' => 0], null, false, true, null],
        ],
        393 => [
